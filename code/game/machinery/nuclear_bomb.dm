...
/obj/item/weapon/folder/envelope/project_orion/Initialize()
	...
	projectorion.set_content("<tt><center><b><font color='red'>CONFIDENTIAL: HEAD RESEARCHER ONLY</font></b>\
	...
	Seeing as how your research station is relatively remote and little to nothing happens there we have decided it best you spearhead this project at this current time. This may change at a later date however.<br>\
	Due to the nature of Project Orion, you will be required to requisition voltuneers from the stationed infantry forces in the area, or 'borrow' a subject you deem to be capable as test subjects for the augmentation process. We advise you only pick subjects with a military background who are especially gifted or talented in the use of a wide range of weaponry, and are capable and willing to follow orders. The confidentialy of this Project is paramount to your continued employment, and life.<br>\
	We have placed the required assets into a surgery room located west of the weapons testing lab. We feel this is sufficient as the final product will be considered a living weapon and is likely to be highly lethal to whomever they engage with.<br>\
	We are expecting great results from this project and it will bolster our military assets, when you are done reading this burn this paper to eliminate any trace of this project. You have full authority to destroy the Project Orion Laboratory should it be discovered, as well as any assets attached to Project Orion. Do not disappoint us.<br>\
	If you are successful in enabling Project Orion then you will be tasked with testing Project Theta in live military operations. You will have limited authority to request transport for Project Orion from local military vessels via clearance 'Omega-Romeo-India-Oscar-November'.<br>\
	Any high command aboard local military vessels should be directed towards documents kept in their personal quarters to verify this code and should allow Project Orion limited use of their facilites and armory during active operations.<br>\
	If the Project Orion subject is designate as AWOL, Unstable, Unusable, or a threat to UNSC or ONI personel you are granted the authority to initate a man hunt or order the execution of the Project Orion Subject. In these cases all Project Orion assets should be reclaimed if possible, or destroyed on-site.<br>\
	<i>I.N.G.</i></tt>")
...
/obj/item/weapon/folder/envelope/orion_code/Initialize()
	...
	We have tasked our Exo-Research station with a special project who's details are only revealed on a need-to-know basis. This document exists solely to inform you of the following pass-phrase.<br>\
	'Omega-Romeo-India-Oscar-November'<br>\
	...
	The scientist who has provided this Pass-Phrase will advise you on what to do should extenuating circumstances arise, and if any equipment or remains should be secured or destroyed by military personnel under your command.<br>\
	<i>I.N.G.</i></tt>")
