...
var/list/first_names_sangheili = file2list("code/modules/halo/species_items/first_sangheili.txt")
var/list/last_names_sangheili = file2list("code/modules/halo/species_items/last_sangheili.txt")
var/list/first_names_kig_yar = file2list("code/modules/halo/species_items/first_kig-yar.txt")
var/list/last_names_kig_yar = file2list("code/modules/halo/species_items/last_kig-yar.txt")
var/list/first_names_brutes = file2list("code/modules/halo/species_items/first_brutes.txt")
var/list/last_names_brutes = file2list("code/modules/halo/species_items/last_brutes.txt")
