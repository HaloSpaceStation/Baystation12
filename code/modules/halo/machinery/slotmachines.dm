/obj/machinery/slot_machine
	...
	attack_hand(var/mob/user as mob)
		user.machine = src
		if (!src.scan)
		// I need to fix the stylesheets.
			var/dat = {"<link rel='stylesheet' href='' /><B>Slot Machine</B><BR>
			<HR><BR>
			...
			if(operation == 1) // Play
				...
				spawn(100)
					if (roll == 1)
						...
						//command_alert("Congratulations [src.scan.registered] on winning the Jackpot!", "Jackpot Winner") idk what im doing
