/obj/item/clothing/under/unsc
	icon = 'code/modules/halo/icons/unscuniform.dmi'
...
/obj/item/clothing/under/unsc/marine
	icon = 'code/modules/halo/icons/marine.dmi'
